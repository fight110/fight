...
define(['jquery'], function(require, exports, module) {
    ...
    $('#HDT-button-install').on('click', function(e){
    	...
    	newTask("/install_yy/install_sql", "初始化数据库");
    	newTask("/install_yy/install_product", "初始化产品.详细");
    	newTask("/install_yy/install_product_group", "初始化产品.搭配");
    	newTask("/install_yy/install_product_display", "初始化产品.陈列");
    	newTask("/install_yy/install_user_dealer", "初始化用户.经销商");
    });
