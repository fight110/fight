define(['jquery', 'app/pager'], function(require, exports, module) {
   ...
   '#a6c96a'
    ...
    api = new pager('/analysis/list', {t:t,ad:1}, {autorun:true, aftercallback:function(html){
        if(currentChart && html){
            currentFunc.call();
        }
    }});

   var api1 = new pager('/analysis/list', {t:t,ad:1,status_val:2}, {autorun:true, id:"#HDT-main1", aftercallback:function(html){
