 ...
 <Worksheet ss:Name="Sheet1">
  <Table>
   ...
   <Row ss:AutoFitHeight="0">
    ...
    {%if $show.k_price_purchase%}<Cell ss:StyleID="s29"><Data ss:Type="String">进货价</Data></Cell>{%/if%}
   ...
   <Row ss:AutoFitHeight="0">
      ...
      <Cell ss:StyleID="s29"><Data ss:Type="Number">{%$show.list[i].bianhao%}</Data></Cell>
      ...
      {%if $show.k_price_purchase%}<Cell ss:StyleID="s35"><Data ss:Type="String">{%$show.list[i].price_purchase%}</Data></Cell>{%/if%}
